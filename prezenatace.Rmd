...
Implementace [Simple Features Access](https://en.wikipedia.org/wiki/Simple_Features) standardu vektorových dat v R.
...
podklad$suma_volicu <- NA # prázdný sloupec
```
---
# Funkce Šelmostroj

```{r selmostroj, eval = T, echo = T, cache = T, message = F, warning = F, out.width = '85%', fig.align="center", fig.asp = 0.55, dpi = 150}
selmostroj <- function(vzdalenost) {
 ...
 stred <- podklad[which.max(podklad$suma_volicu), ] 
...
##- je o něco složitější než klikání v GUI
##- podporuje opakovatelnost výpočtu
##- podporuje iteraci (for cyklus)
##- navazuje na širší R ekosystém
##- je Open Source - v dobrém i zlém...
